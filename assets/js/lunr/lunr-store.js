var store = [{
        "title": "Better Globe",
        "excerpt":"Opdateret: Jul 2, 2026 Første investeringsdato: Jun 14, 2019 Med Better Globe investerer du i (ikke-specifikke) træer i Afrika. Forretningsmodellen lyder i teorien smuk: Efter fem år begynder Better Globe at kunne tjene penge på at høste f.eks. frugt eller frø, hvorefter investorerne får de første løbende udbetalinger på deres...","categories": ["Crowdlending"],
        "tags": ["crowdlending","Sverige","afrika","kritik"],
        "url": "/platform/betterglobe/",
        "teaser": "/assets/images/logo/betterglobe.png"
      },{
        "title": "Bondora",
        "excerpt":"Opdateret: Jul 2, 2026 Første investeringsdato: 20. februar 2019 Status: Aktiv platform på markedet, men jeg har foretaget et fuldstændigt exit. Da jeg i starten af 2019 gik ind på den estiske crowdlending-platform Bondora, var det midt i en periode, hvor deres traditionelle P2P-låneporteføljer (hvor man selv købte lån med...","categories": ["Crowdlending"],
        "tags": ["crowdlending","Estland","Østeuropa","udenlandsk crowdlending","exited"],
        "url": "/platform/bondora/",
        "teaser": "/assets/images/logo/bondora.png"
      },{
        "title": "Bulkestate",
        "excerpt":"Opdateret: Jul 2, 2026 Første investeringsdato: 20. februar 2019 Status: Platformen er lukket for nye investeringer og behandler kun eksisterende projekter. Hos Bulkestate investeres der i udviklingslån til boligprojekter i Estland og Letland. Platformen er i dag i gang med at afvikle eksisterende projekter. Selskabet har officielt indstillet indsamlingen af...","categories": ["Crowdlending"],
        "tags": ["crowdlending","ejendomsinvestering","Estland","Østeuropa","udestående"],
        "url": "/platform/bulkestate/",
        "teaser": "/assets/images/logo/bulkestate.png"
      },{
        "title": "Crowdestor",
        "excerpt":"Crowdestor var en estisk peer-to-peer platform med løfter om tårnhøje renter. I dag er platformen lukket for nye lån og kæmper med massive misligholdelser. Jeg har investeret på Crowdestor siden marts 2019. I den spæde start opfatede jeg Crowdestor som en spændende og velfungerende platform, der tilbød adgang til meget...","categories": ["Crowdlending"],
        "tags": ["crowdlending","Estland","Østeuropa","udestående","kritik"],
        ...
        "title": "Funderbeam",
        "excerpt":"Opdateret: Jul 2, 2026 Første investeringsdato: Jul 4, 2019 Status: Aktiv platform på markedet, men jeg har foretaget et fuldstændigt exit. Hvis du vil læse min oprindelige og fulde introduktion til konceptet, kan du læse min anmeldelse af Funderbeam her. Funderbeam tilbød investering i tidlige startup-virksomheder via blockchain-baserede ‘shares’ og...","categories": ["Crowdlending"],
        "tags": ["crowdlending","blockchain","Estland","exited"],
        "url": "/platform/funderbeam/",
        "teaser": "/assets/images/logo/funderbeam.png"
      },{
        "title": "Housers",
        "excerpt":"Opdateret: Jul 2, 2026 Første investeringsdato: 5. marts 2019 Status: Platformen er permanent lukket. Housers gav oprindeligt mulighed for at investere i ejendomsprojekter i Spanien, Italien og Portugal. Platformen er i dag lukket permanent efter massive problemer. Housers var i min spæde start en af mine absolutte favoritplatforme, fordi den...","categories": ["Crowdlending"],
        "tags": ["crowdlending","ejendomsinvestering","Spanien","udenlandsk crowdlending","lukket"],
        "url": "/platform/housers/",
        "teaser": "/assets/images/logo/housers.png"
      },{
        "title": "Iuvo Group",
        "excerpt":"Opdateret: Jul 2, 2026 Første investeringsdato: 21. maj 2019 Status: Platformen er lukket for nye investeringer og under afvikling. Iuvo Group opererede fra Estland med fokus på private forbrugslån. Platformen er i dag lukket for nye lån og under afvikling. Selskabet har officielt indstillet udstedelsen af nye forbrugslån og befinder...","categories": ["Crowdlending"],
        "tags": ["crowdlending","Estland","Østeuropa","udenlandsk crowdlending","lukket"],
        "url": "/platform/iuvo/",
        ...
        "title": "Kuflink",
        "excerpt":"Opdateret: Jul 2, 2026 Første investeringsdato: 21. august 2019 Status: Aktiv platform, men jeg har personligt valgt at lave et fuldstændigt exit. Hos Kuflink investerer du i ejendomme og ejendomsudvikling i Storbritannien. Platformen er fuldt FCA-reguleret. Jeg valgte oprindeligt at gå ind i Kuflink i august 2019, primært fordi deres...","categories": ["Crowdlending"],
        "tags": ["crowdlending","ejendomme","England","udenlandsk crowdlending","exited"],
        "url": "/platform/kuflink/",
        "teaser": "/assets/images/logo/kuflink.png"
      },{
        "title": "Lendahand",
        "excerpt":"Opdateret: Jul 2, 2026 Første investeringsdato: 22. juni 2019 Status: Aktiv platform i min portefølje. En reguleret platform til impact-investering, hvor det sociale aftryk vægter højere end det finansielle afkast. Lendahand er en hollandsk platform, hvor du kan lave impact-investering i sociale projekter og mikrolån i Afrika, Asien og Sydamerika....","categories": ["Crowdlending"],
        "tags": ["crowdlending","Holland","udenlandsk crowdlending","aktiv","bæredygtighed"],
        ...
        "title": "Mintos",
        "excerpt":"Mintos er Europas største markedsplads for crowdlending. Platformen er i dag fuldt reguleret og baseret i Letland. Jeg har investeret i lån hos estisk/letiske Mintos siden starten van 2019. Historisk har jeg ligget stabilt med en solid intern rente (XIRR) på over 10%+. Selvom Mintos er en af de platforme...","categories": ["Crowdlending"],
        "tags": ["crowdlending","Letland","Østeuropa","udenlandsk crowdlending","aktiv"],
        "url": "/platform/mintos/",
        ...
        "title": "PeerBerry",
        "excerpt":"PeerBerry tilbyder kortsigtede forbrugs- og erhvervslån med omkring 9-11% i afkast og en gennemtestet koncurngaranti. Det stærkeste alternativ til Mintos. Jeg har investeret på PeerBerry siden starten af 2019, og jeg har historisk haft et stabilt internt afkast (XIRR) på over 11%. Her kan du læse mine opdaterede erfaringer med...","categories": ["Crowdlending"],
        "tags": ["crowdlending","Letland","Kroatien","udenlandsk crowdlending","aktiv"],
        ...
        "title": "Trine",
        "excerpt":"Trine har et særligt bæredygtigt sigte med cleantech og clean energy, hvor du låner penge ud til solcelleprojekter i Afrika. Jeg investerede første gang i den svenske crowdlending-platform Trine i februar 2019. Jeg blev oprindeligt interesseret i platformen, fordi jeg gerne ville eksperimentere med bæredygtig og grøn investering. Trine formidler...","categories": ["Crowdlending"],
        "tags": ["crowdlending","Sverige","udenlandsk crowdlending","aktiv","bæredygtighed"],
        "url": "/platform/trine/",
        ...
        "title": "Crowdlending status og opdatering: Spar dig for mine dyre fejl",
        "excerpt":"Discloure: Links markeret med asteriks (*) er reklamelinks. Hvis du bruger linket, tjener jeg kommision, og du får måske en bonus. Crowdlending har i mange år været et yderst populært emne på alverdens finansblogs. Afkastet på platformene slår ofte de traditionelle aktivklasser, og løfterne om tocifrede, passive rentesatser kan være...","categories": ["Investering","Opdateringer"],
        ...
        "excerpt":"Discloure: Links markeret med asteriks (*) er reklamelinks. Hvis du bruger linket, tjener jeg kommision, og du får måske en bonus. Når man læser om at skabe passiv indkomst og opbygge en solid portefølje mod økonomisk uafhængighed (FIRE), dukker ejendomsinvestering stort set altid op som et centralt punkt. Historisk set...","categories": ["Opsparing"],
        ...
        "title": "Se gratis tv online på nettet: 10 forslag til kanaler",
        ...
        "title": "Kirkegården: Den hudløst ærlige historie om de crowdlending-platforme, jeg har forladt eller tabt penge på",
        "excerpt":"Inden for crowdlending taler alle om de høje afkast. Ingen taler om de platforme, der crasher eller snyder investorerne. Her er mit ærlige kig i bakspejlet og mine personlige notater om de platforme, jeg har forladt eller mistet penge på. Når du læser om crowdlending på diverse finansblogs, er det...","categories": ["Investering"],
        "tags": ["erfaringer","crowdlending","tab","svindel"],
        "url": "/crowdlending-svindel-erfaringer/",
        "teaser": "https://images.unsplash.com/photo-1586049188868-63fa351cf340?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80"
      },]
