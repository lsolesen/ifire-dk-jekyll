...
Hvis du bruger fx både Nordnet og Saxo til at købe værdipapirer, så kan du ret let med [Atlaz\*](/go/atlaz/) få et **gratis** overblik over dine samlede investeringer.
...
Hvis vi kigger på den danske crowdlending, så har jeg 4,90% i intern rente på [The Many\*](/go/themany/), og det er meget tilfredsstillende, når man får udbetalt afkast på sin konto jævnligt. Min interne rente på [Flexfunding](/platform/flexfunding/) er kun på 1,61% pga. de tidligere problemer med lån, der ikke bliver betalt tilbage. [Kameo](/platform/kameo/) er stadig den danske platform, jeg har med det bedste afkast, men det er virkelig vanskeligt at få købt nye lån, da de bliver revet væk. [Lendino\*](/go/lendino/), som er nyeste skud på min danske crowdlending portefølje, har jeg endnu ikke fået renter for.
