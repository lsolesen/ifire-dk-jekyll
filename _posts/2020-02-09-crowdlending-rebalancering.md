...
- **Geo.** Hvor geografisk spredte kan man lave investeringer. Fx har nogle af ejendomsplatformene stort set kun en by, fx <del>[Brickshare\*](/platform/themany/)</del><ins>[The Many\*](/go/themany/)</ins>, mens [PeerBerry\*](/go/peerberry/) opererer i mange lande.
