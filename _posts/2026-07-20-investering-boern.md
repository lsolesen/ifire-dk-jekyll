---
title: "Investering til børn (2026): Den ultimative forældreguide til frikort, ASK og Nordnet"
permalink: /investering-til-boern-guide/
category:
  - Privatøkonomi
tags:
  - investering til børn
  - børneopsparing
  - aktiesparekonto mindreårige
  - frikort
excerpt: "Hvordan investerer man bedst for sine børn? Læs den komplette guide til Aktiesparekonto, frikort og aldersopsparing, og lær hvordan du tackler skiftet, når børnene får et fritidsjob."
toc: true
header:
...
Her er hvad jeg gør for at børnene kan opleve effekten af *[renters rente](/renters-rente/)*. 
...
> ⚠️ **Husk:** Beregneren er baseret på min egen fortolkning af skattereglerne i 2026 og er *ikke* professionel rådgivning. Investering indebærer risiko for tab – gør altid dit eget forarbejde.
{ .notice--danger }

{% include borneinvest-guide.html %}

---

## Tidslinjen for investeringer for børn

{% include investeringstidslinje.html 
   tid="Fødsel til 18/21 år"
   farve="#16a34a"
   badge_navn="Skattefri" badge_baggrund="#dcfce7" badge_tekst="#15803d"
   titel="1. Klassisk Børneopsparing (Banken)"
   beskrivelse="Jeg starter med børneopsparingen, hvor alt afkast og udbytte er 100% skattefrit under hele bindingsperioden."
   meta_skat="0% (Skattefri)"
   meta_loft="6.000 kr. årligt / 72.000 kr. totalt"
   meta_tid="Låst til 18 eller 21 år"
%}

{% include investeringstidslinje.html 
   tid="Barn (Uden job)"
   farve="#64748b"
   badge_navn="Frikort" badge_baggrund="#f1f5f9" badge_tekst="#334155"
   titel="2. Det Frie Depot via Frikortet"
   beskrivelse="Når barnet vil investere ekstra midler udover børneopsparingen kan barnets personfradrag (frikort) udnyttes til at få 0% i skat. OBS: Jeg vælger fonde eller ETF'er, der lagerbeskattes som kapitalindkomst."
   meta_skat="0% via frikort (Kapitalindkomst)"
   meta_loft="Op til 54.100 kr. årligt (2026)"
   meta_tid="Kan altid hæves"
%}

{% include investeringstidslinje.html 
   tid="⏳ Skiftezonen 1 - Teenager (Fritidsjob tager personfradraget)"
   farve="#2563eb"
   badge_navn="Lav skat" badge_baggrund="#dbeafe" badge_tekst="#1e40af"
   titel="3. Muligt skift til Aktiesparekontoen (ASK)"
   beskrivelse="Når barnet rammer 13-15 år og får et ungarbejde, kan lønnen spise en del af frikortet. Når barnet ikke længere kan få fradrag for kapitalindkomsten, vil jeg rykke investeringerne til Aktiesparekontoen for mindreårige, som har 17% lagerskat."
   meta_skat="17% fast skat (Lagerprincip)"
   meta_loft="174.200 kr. totalt (2026)"
   meta_tid="Kan altid hæves"
%}

{% include investeringstidslinje.html 
   tid="Det virkelig langsigtede udnyttelse af renters rente effekten"
   farve="#7c3aed"
   badge_navn="PAL-skat" badge_baggrund="#f3e8ff" badge_tekst="#6b21a8"
   titel="4. Aldersopsparingen (AOS)"
   beskrivelse="Vil du give dit barn et ekstremt langsigtet forspring, kan du supplere med en aldersopsparing. Afkastet beskattes med den lavest mulige skattesats."
   meta_skat="15,3% (PAL-skat)"
   meta_loft="9.900 kr. årligt (2026)"
   meta_tid="Låst til pensionsalderen"
%}

{% include investeringstidslinje.html 
   tid="⏳ Skiftezone 2 - Myndig (18 eller 21 år)"
   farve="#f59e0b"
   badge_navn="Voksenliv" badge_baggrund="#fef3c7" badge_tekst="#b45309"
   titel="5. Udløb for børneopsparingen og geninvestering"
   beskrivelse="Når børneopsparingen udbetales, sker det 100% skattefrit. Den unge kan nu geninvestere midlerne på egen hånd – først på egen ASK og derefter via almindelig aktieindkomst (27%/42%)."
   meta_skat="Alt efter depot"
   meta_loft="Alt efter depot"
   meta_tid="Fuld råderet over formuen"
   sidste=true
%}
...
* **Strategi:** Jeg makser altid børneopsparingen ud først. Hvis du vil have 100% styr på alle de juridiske detaljer, bindingsperioder, og hvordan du flytter kontoen mellem banker, kan du læse min dybdegående [guide til reglerne for børneopsparing her](/borneopsparing/). Nordnet har desværre ikke denne kontotype.

I min bank er der ekstra depotgebyr på udenlandske værdipapirer, så jeg har valgt en [dansk udbyttebetalende fond](/danske-investeringsforeninger-fire-realisation/) med lave årlige omkostninger. Ulempen er at jeg har et udbytte hvert år, der skal geninvesteres.
{ .notice--info }

{% include investeringskort.html depot="borneopsparing" fonde="SPIIMA:100" %}
...
{% include investeringskort.html depot="aldersopsparing" fonde="NNGBLINDX:88,NNEMINDX:12" %}
...
1. **Brug de rigtige kontotyper:** Hvis du sætter pengene på barnets **Aktiesparekonto** eller **Aldersopsparing**, gælder reglen ikke. Her bliver barnet altid beskattet direkte på kontoen (henholdsvis 17% og 15,3%), uanset hvem pengene kommer fra.
2. **Lad bedsteforældre eller onkler give gaven:** Hvis pengene kommer fra andre end forældrene (f.eks. en onkel eller bedsteforældre), bliver barnet altid beskattet på sit eget frikort på det frie depot. Du kan læse min personlige case om, hvordan jeg greb netop dette an som onkel her: **[Gave til nevø eller niece? Sådan startede jeg en investering på Nordnet](/nevo-rigdomsformel/)**.
...
* **Hvad skal du købe her?** På ASK skal du købe [aktiebaserede fonde eller ETF'er](/bedste-etf-skats-positivliste/), der står på Skattestyrelsens positivliste. Et populært og billigt valg er den akkumulerende globale ETF **iShares MSCI ACWI (IUSQ)** med en lav ÅOP på 0,20 %.

{% include investeringskort.html depot="ask" fonde="IUSQ" %}
...
👉 **Læs:** [Tjen 17.000 kr. om måneden for under 10% i skat](/okonomisk-uafhaengig-skattefri-fire-model/)
