---
layout: single
title: "Min Investorrejse: Fra kompleksitet til enkelhed"
permalink: /min-investorrejse/
redirect_from:
  - /investorrejse/
  - /mine-investeringer/crowdlending/
  - /mine-investeringer/kryptovaluta/
...
description: "Dette er den ucensurerede historie om min investorrejse. Om tusindvis af timer brugt i regneark, at logge ind på 26 platforme, faldende knive på aktiemarkedet og de lærepenge, der førte til min nuværende, simple strategi."
author_profile: true
toc: true
tags:
  - fundament
...
På denne side har jeg samlet min historik. Betragt det som et museum over min investeringsrejse. Det er ikke en anbefaling til, hvad du skal gøre – men et ærligt indblik i de fejl, der har kostet mig penge eller unødvendig tankevirksomhed, og som endte med at forme [min nuværende, simple investeringsstrategi](/min-investeringsstrategi/).
...
Det krævede et absurd administrativt arbejde. For at undgå valutagebyrer kørte jeg overførsler gennem [Revolut](/go/revolut/) for at veksle DKK til EUR og derfra fordele dem ud til de mange platforme i Baltikum og andre steder i verden.

Jeg brugte weekender på at sætte det gratis open-source program [Portfolio Performance](/hvordan-tracker-jeg-min-portefolje/) op for at kunne udregne den præcise XIRR på tværs af platforme.

**Copytrading og kryptovalutaens vilde ridt**
Udover crowdlending ville jeg også eksperimentere med andre hypede trends. I foråret 2019 oprettede jeg en konto på eToro for at afprøve *copytrading*, hvor platformen automatisk kopierer andre udvalgte investorers handler [1]. I starten føltes det fantastisk – i juni 2019 ramte jeg en urealiseret intern rente på næsten 40% [2]. Men glæden var kort. De *tradere*, jeg fulgte, tog enorm høj risiko, og pludselig var porteføljen i minus [3]. På grund af et højt udbetalingsgebyr på 25 USD endte pengene med at være mere eller mindre strandet på platformen [1, 4].
...
Jeg var blevet et skoleeksempel på [adfærdspsykologiens fælder på aktiemarkedet](/adfaerdspsykologi-aktiemarkedet/): *Anchoring* og *Loss Aversion*.
...
Da jeg begyndte at tage kontrol over mine egne penge, opdagede jeg hurtigt, at det ikke kun handlede om *hvad* jeg købte, men i lige så høj grad om *hvor* jeg placerede det for at optimere [skatten af investeringerne](/skat-af-aktier/).
...
Tjek min nuværende [investeringsportefølje](/mine-investeringer/) for at se, hvordan jeg gør i dag.
...
*(Du kan læse den fulde, hudløst ærlige historie om disse tab og svindelnumre i min artikel: **[Kirkegården: De platforme jeg har forladt eller tabt penge på &rarr;](/crowdlending-svindel-erfaringer/)**)*
